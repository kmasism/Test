...
namespace UpgradeHelpers
{
    ...
    public class ColAlignmentProperty
    {
        ...
        public DataGridViewContentAlignment this[int index]
        {
            get
            {
                if (index == 0 && parent.RowHeadersVisible)
                {
            ...
            set
            {
                ...
                SetAlignmentProperty(index, value);
            }
        }

        /// <summary>
        /// Sets a value to the alignment property for a specified column.
        /// </summary>
        /// <param name="index">The index of the column.</param>
        /// <param name="value">The alignment value to be Set.</param>
        private void SetAlignmentProperty(int index, DataGridViewContentAlignment value)
        {
            int realindex = parent.RowHeadersVisible ? index - 1 : index;
            DataGridViewColumn column = parent.Columns[realindex];
