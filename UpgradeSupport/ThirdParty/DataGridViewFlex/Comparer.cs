...
namespace UpgradeHelpers
{
    ...
    {
        private readonly SortSettings sortSetting = SortSettings.SortGenericAscending;
        ...
        public int Compare(object x, object y)
        {
            ...
            CompareResult = CompareUsingSortSetting(value1, value2);
            return CompareResult * sortOrder;
        }

        /// <summary>
        /// Performs a comparison using the SortSettings with the values of the DataGrids
        /// </summary>
        /// <param name="value1">Value for cells of DataGrid 1</param>
        /// <param name="value2">Value for cells of DataGrid 2</param>
        /// <returns>Returns the value generated by the perform of the comparison between value1 and value2</returns>
        private int CompareUsingSortSetting(string value1, string value2)
        {
            int CompareResult = 0;
            ...
            switch (sortSetting)
            {
                ...
                case SortSettings.SortGenericDescending:
                    ...
                    {
                        if (tempGeneric1 > tempGeneric2)
                        {
                            CompareResult = 1;
                        }
                        CompareResult = tempGeneric1 < tempGeneric2 ? -1 : 0;
                    }
