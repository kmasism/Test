...
using UpgradeHelpers.DB.Controls;
...
namespace UpgradeHelpers.DB.ADO
{
    ...
    /// </summary>
    [ToolboxItem(true)]
    public partial class ADODataControlHelper : DataControlHelper
    {
        ...
        private Label l_caption;
        private ADORecordSetHelper _recordSet;
        ...
        /// Default Constructor
        /// </summary>
        public ADODataControlHelper(Label lCaption)
        {
            l_caption = lCaption;
            InitializeComponent();
        }
        ...
        public override RecordSetHelper GenericRecordset
        {
            get
            {
                if (_recordSet == null)
                {
                    _recordSet = new ADORecordSetHelper();
                    if (!DesignMode)
                    {
                        InitRecordset();
                    }
            ...
            set
            {
                ...
                {
                    DeInitRecordset();
                    _recordSet = (ADORecordSetHelper)value;
                    if (_recordSet != null)
                    {
                        InitRecordset();
                        if (Enabled)
        ...
        /// Internal RecordSet
        /// </summary>
        public ADORecordSetHelper Recordset
        {
            get
            {
                return (ADORecordSetHelper)GenericRecordset;
            }
            set
            {
                GenericRecordset = value;
            }
        }
        ...
        protected override void DeInitRecordset()
        {
            ...
            Recordset.WillChangeField -= Recordset_WillChangeField;
            Recordset.WillChangeRecord -= Recordset_WillChangeRecord;
            Recordset.WillChangeRecordset -= Recordset_WillChangeRecordset;
            Recordset.WillMove -= Recordset_WillMove;
            Recordset.EndOfRecordset -= Recordset_EndOfRecordset;
            Recordset.FieldChangeComplete -= Recordset_FieldChangeComplete;
            Recordset.MoveComplete -= Recordset_MoveComplete;
            Recordset.RecordChangeComplete -= Recordset_RecordChangeComplete;
            Recordset.RecordsetChangeComplete -= Recordset_RecordsetChangeComplete;
